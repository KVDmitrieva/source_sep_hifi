...
class Generator(BaseModel):
    def __init__(self, spectral_unet_params, generator_params, wave_unet_params, spectral_mask_params):
        super().__init__()
    ...
    def forward(self, mel, audio=None, mode='vocoder'):
        ...
        mask_out = self.spec_mask(wave_out, spec_out) if mode == 'vocoder' else self.spec_mask(wave_out)
        return mask_out
